...
) TO 'dist/euroappa-nuts-2021-h3-level-4.gpkg'
...
) TO 'dist/euroappa-cntr-2024-h3-level-4.gpkg'
WITH (FORMAT gdal, DRIVER 'GPKG', SRS 'EPSG:4326', OVERWRITE true);
...
) TO 'dist/euroappa-nuts-2021-h3-level-6.gpkg'
WITH (FORMAT gdal, DRIVER 'GPKG', SRS 'EPSG:4326', OVERWRITE true);
...
) TO 'dist/euroappa-cntr-2024-h3-level-6.gpkg'
WITH (FORMAT gdal, DRIVER 'GPKG', SRS 'EPSG:4326', OVERWRITE true);
